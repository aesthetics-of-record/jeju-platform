  ...
  return (
    <div className='w-full p-2'>
      ...
      >
        ...
        />
        <div
          className='group flex items-center justify-center absolute top-32 left-52 w-[100px] h-[100px] rounded-full border-2 border-slate-300 hover:scale-110 transition duration-300 hover:shadow-md'
          onClick={() => {
