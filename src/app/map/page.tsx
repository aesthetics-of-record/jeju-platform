  ...
  return (
    <div className='w-full p-6'>
      ...
      >
        ...
        />
        <div
          className='group flex items-center justify-center absolute top-32 left-52 w-[250px] h-[250px] rounded-full border-2 border-slate-300 hover:scale-110 transition duration-300 hover:shadow-md'
          onClick={() => {
